...
export default function EmbedPage() {
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-slate-900 mb-1">Embed on your website</h1>
        <p className="text-slate-500 text-sm">Copy the code and paste it before the closing &lt;/body&gt; tag</p>
      </div>
      ...
      {agents.length === 0 ? (
        ...
        <div className="max-w-2xl space-y-6">
          ...
          <div className="bg-blue-50 rounded-xl border border-blue-100 p-4 text-sm text-blue-700">
            <p className="font-medium mb-1">Direct chat link:</p>
            <a
              href={`/chat/${selected}`}
              target="_blank"
