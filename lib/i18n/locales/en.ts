...
export const en: LandingDict = {
  ...
  calculator: {
    ...
    windowLabel: 'Patient retention window',
    windowHint: 'how many years the clinic typically retains a patient',
    conversionNote: 'Estimate based on a 30% booking conversion for missed inquiries, 1.6 repeat visits/year, and 8% annual growth from lost referrals.',
    monthlyLabel: 'Hidden losses per month',
    monthlySuffix: 'in missed revenue every month',
    ltvLabelByYears: ['1-year LTV leak', '2-year LTV leak', '3-year LTV leak'],
    ltvSuffix: 'accounting for repeat visits and referrals',
