...
export const cz: LandingDict = {
  ...
  calculator: {
    ...
    windowLabel: 'Okno udržení pacienta',
    windowHint: 'kolik let si ordinace obvykle udrží pacienta',
    conversionNote: 'Odhad na základě 30% konverze zmeškaných dotazů, 1,6 opakovaných návštěv ročně a 8% ročního růstu díky ztraceným doporučením.',
    monthlyLabel: 'Skryté ztráty za měsíc',
    monthlySuffix: 'ušlého příjmu měsíčně',
    ltvLabelByYears: ['1letý LTV výpadek', '2letý LTV výpadek', '3letý LTV výpadek'],
    ltvSuffix: 'včetně opakovaných návštěv a doporučení',
