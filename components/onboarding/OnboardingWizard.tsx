...
export default function OnboardingWizard() {
  ...
  async function createAgent() {
    ...
    const { data } = await supabase.from('agents').insert({
      ...
      name: agentName,
      description: '',
      system_prompt: `You are ${agentName}, an AI administrator for a dental clinic. Help patients with questions about services, prices and appointments. Be friendly and concise. Always reply in the same language the patient uses.`,
